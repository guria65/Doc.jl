...
@test obj.content[1].tag == :literal
...
@test obj.content[1].tag == :listing
@test obj.content[1].meta[:group] == :verbatim
...
@test obj.content[1].tag == :example
...
@test obj.content[1].tag == :sidebar
@test obj.content[1].meta[:group] == :normal  
